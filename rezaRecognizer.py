...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        #############REZA
        self.select_lang = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.select_lang.setGeometry(QtCore.QRect(40, 170, 171, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.select_lang.setFont(font)
        self.select_lang.setObjectName("fr-CA en-CA en-US fr-FR")
        #############REZA
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionOpen_mp4_video_recording.setText(_translate("MainWindow", "Open mp3 recording"))
    ...
    def transcribe_audio(self, audio_file):
        ...
        ## REZA
        if len(self.select_lang.toPlainText()) > 0:
            self.selected_lang = self.select_lang.toPlainText()
        else:
            self.selected_lang = "en-US"
        ###REZA
        # Use thread to process in the background and avoid freezing the GUI
        self.thread = transcriptionThread(total_duration, audio_file, self.output_file, self.selected_lang)
...
class transcriptionThread(QThread):
    ...
    def __init__(self, total_duration, audio_file, output_file, selected_lang):
        """Initialization function."""
        QThread.__init__(self)
